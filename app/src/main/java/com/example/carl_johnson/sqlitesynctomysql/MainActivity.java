package com.example.carl_johnson.sqlitesynctomysql;
    ...
    public void syncSQLiteMySQLDB(){
        ...
        if(userList.size()!=0){
            if(controller.dbSyncCount() != 0){
                ...
                client.post("http://tejasgawali.16mb.com/sqlitemysqlsync/insertuser.php",params ,new AsyncHttpResponseHandler() {
                    @Override
